...
firebase.auth().onAuthStateChanged(async function (user) {
  ...
  buttonforSubmitting.addEventListener("click", function (event) {
    ...
    var RemoveDiv = CommentsToTeacher.innerHTML.split(
      '<div class="ql-editor" data-gramm="false" data-placeholder="Quill WYSIWYG editor" spellcheck="false" contenteditable="true">'
    );
